export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        openTerminalAppTitle: '第三步：打开终端APP',
  ...
  admin: {
    ...
    proxies: {
      ...
      networkMonitorTitle: '自动网络检测并暂停调度',
      networkMonitorUnknown: '状态读取中',
      networkMonitorRunning: '运行中',
      networkMonitorStopped: '已启用但未运行',
      networkMonitorDisabled: '已停用',
      networkMonitorScanning: '扫描中',
      networkMonitorInterval: '常规间隔 {seconds}s；失败代理按退避复检',
      networkStatusOnline: '网络在线',
      networkStatusOfflineActive: '已启用但网络离线',
      networkStatusOfflineActiveHint: '该代理未被管理员禁用，但后台网络监控已判定当前出口不可用。',
      offlineProxyTestExpected: '该代理已被后台监控判定离线，本次测试失败属于预期；请等待恢复或更换 online 出口',
      networkMonitorSummary: '最近：总 {total} / 在线 {online} / 离线 {offline} / 错误 {errors}',
      networkMonitorEnabled: '已开启自动网络检测',
      networkMonitorDisabledSuccess: '已关闭自动网络检测并恢复自动暂停账号',
      networkMonitorLoadFailed: '加载自动网络检测状态失败',
      networkMonitorUpdateFailed: '更新自动网络检测状态失败',
