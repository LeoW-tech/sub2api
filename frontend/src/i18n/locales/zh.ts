export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      allTypes: "全部类型",
      allStatus: "全部状态",
      allTokenStatus: "全部Token",
      allCapacity: "全部容量",
      allIPs: "全部 IP",
      allNetworkStatus: "全部网络状态",
      allGroups: "全部分组",
      searchIPs: "搜索 IP 或代理名...",
    ...
    proxies: {
      ...
      networkMonitor: "网络巡检",
      networkMonitorIntervalMinutes: "{minutes}分钟",
      networkMonitorIntervalSeconds: "{seconds}秒",
      networkMonitorRunning: "运行中",
      networkMonitorScanning: "巡检中",
      networkMonitorStopped: "未运行",
      networkMonitorDisabled: "已关闭",
      networkMonitorEnabled: "网络巡检已开启",
      networkMonitorDisabledSuccess: "网络巡检已关闭",
      networkMonitorLoadFailed: "加载网络巡检状态失败",
      networkMonitorUpdateFailed: "更新网络巡检状态失败",
      allProtocols: "全部协议",
      allStatus: "全部状态",
      searchProxies: "搜索代理...",
      protocols: {
      ...
      name: "名称",
      externalKey: "门标识",
      externalKeyPlaceholder: "例如 door-hk-w10",
      protocol: "协议",
      host: "主机",
      port: "端口",
      username: "用户名（可选）",
      password: "密码（可选）",
      exitIp: "出口 IP（可选）",
      exitIpPlaceholder: "例如 203.0.113.10",
      status: "状态",
      enterProxyName: "请输入代理名称",
      optionalAuth: "可选认证信息",
      leaveEmptyToKeep: "留空保持不变",
      externalKeyInline: "门标识",
      form: {
        hostPlaceholder: "请输入主机地址",
        portPlaceholder: "请输入端口",
      },
