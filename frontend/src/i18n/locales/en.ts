export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      allTypes: 'All Types',
      allStatus: 'All Status',
      allTokenStatus: 'All RT Status',
      hasRT: 'Has RT',
      noRT: 'No RT',
      allCapacity: 'All Capacity Status',
      capacityConcurrent: 'Has Active Concurrency',
      allNetworkStatus: 'All Network Status',
      allIPs: 'All Exit IPs',
      allGroups: 'All Groups',
    ...
    proxies: {
      ...
      networkMonitorTitle: 'Auto network check and scheduling pause',
      networkMonitorUnknown: 'Loading status',
      networkMonitorRunning: 'Running',
      networkMonitorStopped: 'Enabled but stopped',
      networkMonitorDisabled: 'Disabled',
      networkMonitorScanning: 'Scanning',
      networkMonitorInterval: 'Regular interval {seconds}s; failed proxies retry with backoff',
      networkStatusOnline: 'Network online',
      networkStatusOfflineActive: 'Enabled but network offline',
      networkStatusOfflineActiveHint: 'This proxy is not disabled by an admin, but background monitoring currently marks its egress network unavailable.',
      offlineProxyTestExpected: 'This proxy is already marked offline by background monitoring; this test failure is expected. Wait for recovery or switch to an online egress.',
      networkMonitorSummary: 'Last: total {total} / online {online} / offline {offline} / errors {errors}',
      networkMonitorEnabled: 'Auto network check enabled',
      networkMonitorDisabledSuccess: 'Auto network check disabled and auto-paused accounts restored',
      networkMonitorLoadFailed: 'Failed to load auto network check status',
      networkMonitorUpdateFailed: 'Failed to update auto network check status',
