export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      capacityConcurrent: "Currently Concurrent",
      hasRT: "Has RT",
      noRT: "No RT",
      privacyUnset: "Unset",
      ...
      bulkActions: {
        ...
        testActivateConfirm:
          "Test and activate the selected {count} account(s)?",
    ...
    proxies: {
      ...
      networkMonitorIntervalMinutes: "{minutes} min",
      networkMonitorIntervalSeconds: "{seconds}s",
      networkMonitorRunning: "Running",
      networkMonitorScanning: "Scanning",
      networkMonitorStopped: "Stopped",
      networkMonitorDisabled: "Off",
      networkMonitorEnabled: "Network monitor enabled",
      networkMonitorDisabledSuccess: "Network monitor disabled",
      networkMonitorLoadFailed: "Failed to load network monitor status",
      networkMonitorUpdateFailed: "Failed to update network monitor",
      ...
      accountNotes: "Notes",
      name: "Name",
      externalKey: "Door Key",
      externalKeyPlaceholder: "e.g. door-hk-w10",
      protocol: "Protocol",
      host: "Host",
      port: "Port",
      username: "Username (Optional)",
      password: "Password (Optional)",
      exitIp: "Exit IP (Optional)",
      exitIpPlaceholder: "e.g. 203.0.113.10",
      status: "Status",
      enterProxyName: "Enter proxy name",
      leaveEmptyToKeep: "Leave empty to keep current",
      optionalAuth: "Optional authentication",
      externalKeyInline: "Door Key",
      form: {
