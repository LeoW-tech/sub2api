export default {
    accounts: {
        ...
        bulkTestActivateSummary: "Bulk test activation completed",
        bulkTestActivateTimeout: "Bulk test activation timed out",
        allCapacity: "All Capacity Status",
        capacityConcurrent: "Has Active Concurrency",
        allIPs: "All Exit IPs",
        searchIPs: "Search IPs",
        allNetworkStatus: "All Network Status",
        allTokenStatus: "All RT Status",
        hasRT: "Has RT",
        noRT: "No RT",
        crsProxyName: "CRS proxy",
        crsProxyStatusConflict: "CRS proxy conflict",
        crsProxyStatusMatched: "CRS proxy matched",
        crsProxyStatusMissing: "CRS proxy missing",
        crsProxyStatusNotFound: "CRS proxy not found",
        crsWarnings: "CRS warnings",
        dataActions: "Data",
        toolActions: "Tools",
        viewColumns: "Columns",
        ...
        bulkActions: {
            testActivate: "Test and activate",
            testActivateConfirm: "Test and activate selected accounts?",
            testActivating: "Testing and activating...",
