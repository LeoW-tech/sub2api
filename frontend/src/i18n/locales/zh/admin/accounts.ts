export default {
  accounts: {
    ...
    bulkActions: {
      ...
      trueRefreshToken: "真刷新令牌",
      trueRefreshTokenStarted: "真刷新令牌任务已启动",
    ...
    openai: {
      ...
      imagesUrlToB64JsonDesc: "仅对 OpenAI API Key 的 Images 非流式响应生效。上游返回的图片缺少 b64_json 但带 url 时，网关下载该 url 并以 base64 回填 b64_json（url 保留），下载失败则原样返回。",
