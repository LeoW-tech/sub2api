<template>
  <div class="flex flex-wrap items-center gap-3">
    ...
    <Select :model-value="filters.network_status" class="w-40" :options="networkOpts" @update:model-value="updateNetworkStatus" @change="$emit('change')" />
...
const updateNetworkStatus = (value: string | number | boolean | null) => { emit('update:filters', { ...props.filters, network_status: value }) }
