        ...
        <div class="py-1">
          <template v-if="account">
            ...
            <template v-if="(account.type === 'oauth' || account.type === 'setup-token') && !isShadow">
              ...
              <button v-if="isOpenAIOAuth" @click="$emit('refresh-subscription', account); $emit('close')" class="flex w-full items-center gap-2 px-4 py-2 text-sm text-emerald-600 hover:bg-gray-100 dark:hover:bg-dark-700">
