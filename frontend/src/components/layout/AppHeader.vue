<template>
  <header class="glass sticky top-0 z-30 border-b border-gray-200/50 dark:border-dark-700/50">
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <!-- Right: Help + Contact + Announcements + Docs + Language + Subscriptions + Balance + User Dropdown -->
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <div
          ...
          class="hidden max-w-[240px] shrink-0 items-center rounded-lg border border-gray-200/60 bg-white/40 px-3 py-1.5 dark:border-dark-700/60 dark:bg-dark-800/40 lg:flex"
        >
          <div class="flex min-w-0 items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
            ...
            <span class="truncate font-medium text-gray-700 dark:text-gray-300">{{ contactInfo }}</span>
          </div>
        </div>
        <!-- Announcement Bell -->
