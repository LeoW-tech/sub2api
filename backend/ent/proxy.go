...
func (*Proxy) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case proxy.FieldName, proxy.FieldExternalKey, proxy.FieldProtocol, proxy.FieldHost, proxy.FieldUsername, proxy.FieldPassword, proxy.FieldStatus, proxy.FieldNetworkStatus, proxy.FieldNetworkErrorMessage, proxy.FieldExitIP, proxy.FieldFallbackMode:
			values[i] = new(sql.NullString)
		case proxy.FieldCreatedAt, proxy.FieldUpdatedAt, proxy.FieldDeletedAt, proxy.FieldNetworkCheckedAt, proxy.FieldExitIPCheckedAt, proxy.FieldExpiresAt:
