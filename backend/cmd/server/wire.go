...
func provideCleanup(
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"ProxyNetworkMonitorService", func() error {
				if proxyNetworkMonitor != nil {
					proxyNetworkMonitor.Stop()
				}
				return nil
			}},
			...
			{"AccountInitialProbeService", func() error {
				if accountInitialProbe != nil {
					accountInitialProbe.Stop()
				}
				return nil
			}},
