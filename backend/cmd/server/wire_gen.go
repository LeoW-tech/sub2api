...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountInitialProbeTaskRepository := repository.NewAccountInitialProbeTaskRepository(db)
	...
	accountBulkTestActivateService := service.ProvideAccountBulkTestActivateService(accountRepository, accountTestService, telegramNotificationService, configConfig)
	...
	accountHandler := admin.NewAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, rateLimitService, accountUsageService, accountTestService, accountBulkTestActivateService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator)
	...
	settingHandler := admin.NewSettingHandler(settingService, emailService, telegramNotificationService, turnstileService, opsService, paymentConfigService, paymentService)
	...
	proxyNetworkMonitorService := service.ProvideProxyNetworkMonitorService(adminService, proxyRepository, telegramNotificationService)
	...
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, schedulerSnapshotService, accountBulkTestActivateService, proxyNetworkMonitorService, tokenRefreshService, accountExpiryService, subscriptionExpiryService, usageCleanupService, accountInitialProbeService, idempotencyCleanupService, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner)
