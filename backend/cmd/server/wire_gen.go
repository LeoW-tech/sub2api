...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	proxyNetworkMonitorService := service.ProvideProxyNetworkMonitorService(adminService, proxyRepository, telegramNotificationService, settingService)
	proxyHandler := handler.ProvideProxyHandler(adminService, settingService, proxyNetworkMonitorService)
	...
	settingHandler := admin.NewSettingHandler(settingService, emailService, telegramNotificationService, turnstileService, opsService, paymentConfigService, paymentService, userAttributeService)
