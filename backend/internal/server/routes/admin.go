...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/bulk-test-activate", h.Admin.Account.BulkTestActivate)
		accounts.POST("/batch-delete", h.Admin.Account.BatchDelete)
		accounts.POST("/batch-clear-error", h.Admin.Account.BatchClearError)
		accounts.POST("/batch-refresh", h.Admin.Account.BatchRefresh)
		accounts.POST("/true-refresh", h.Admin.Account.TrueRefresh)
...
func registerOpenAIOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	openai := admin.Group("/openai")
	{
		...
		openai.POST("/accounts/refresh-subscriptions", h.Admin.OpenAIOAuth.RefreshAccountSubscriptions)
		openai.POST("/accounts/:id/refresh", h.Admin.OpenAIOAuth.RefreshAccountToken)
		openai.POST("/accounts/:id/refresh-subscription", h.Admin.OpenAIOAuth.RefreshAccountSubscription)
		openai.POST("/create-from-oauth", h.Admin.OpenAIOAuth.CreateAccountFromOAuth)
		openai.POST("/complete-pending-create", h.Admin.OpenAIOAuth.CompletePendingCreate)
...
func registerProxyRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	proxies := admin.Group("/proxies")
	{
		...
		proxies.GET("/network-monitor", h.Admin.Proxy.GetNetworkMonitorStatus)
		proxies.PUT("/network-monitor", h.Admin.Proxy.UpdateNetworkMonitorStatus)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.POST("/send-test-telegram", h.Admin.Setting.SendTestTelegram)
