...
// OpenAIQuotaLimitWindow describes one quota window that has reached its
// configured auto-pause threshold.
...
// OpenAIQuotaLimitStatus exposes quota-limit details for admin and ops views.
...
// EvaluateOpenAIQuotaLimitStatus evaluates all configured OpenAI quota windows
...
// openAIChatGPTInternalTextMessage builds the Responses input shape accepted by
// ChatGPT's internal API and shared by gateway normalization and health checks.
