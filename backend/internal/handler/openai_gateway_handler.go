...
func resolveOpenAIChatCompletionsSchedulerFallbackModel(apiKey *service.APIKey, requestedModel string) string {
	if apiKey == nil || apiKey.Group == nil {
		return ""
	}
	...
	if strings.EqualFold(strings.TrimSpace(requestedModel), fallbackModel) {
		return ""
	}
