...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		IsQuotaLimited:          a.IsQuotaLimited,
		QuotaLimitWindows:       append([]string(nil), a.QuotaLimitWindows...),
		QuotaLimitResetAt:       a.QuotaLimitResetAt,
		QuotaLimitRemainingSec:  a.QuotaLimitRemainingSec,
